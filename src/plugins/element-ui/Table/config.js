    ...
    expand: {
        ...
        renderCell: function (
          ...
          classes.push('el-table__expand-icon--expanded');
            ...
            let iconClasses = [iconConfig.fold];
            if (store.states.expandRows.indexOf(row) > -1) {
                // classes.push('el-table__expand-icon--expanded');
                iconClasses = [iconConfig.expand];
            }
...
export function treeCellPrefix(
    ...
    if (typeof treeNode.expanded === 'boolean' && !treeNode.noLazyChildren) {
        ...
        const expandClasses = ['el-table__expand-icon'];
        let iconClasses = [treeNode.expanded ? iconConfig.expand : iconConfig.fold];
        if (treeNode.loading) {
